...
- 기술개발 배경
    ...
    - 이를 해결하기 위해 <ins>CCTV 실시간 범죄 분석 및 보안 알림이 중요한 기술적 대안</ins>
...
<span style="background-color: #f5f0ff">실시간으로 CCTV 영상을 분석</span>하여 여러 범죄 행위를 신속하게 감지한 후, 가게 주인에게 즉각적으로 알림을 제공하여 빠른 대응이 가능하도록 함.

- 실시간으로 CCTV 영상을 분석하여 범죄 행위(폭력)를 신속하게 감지한 후, 가게 주인에게 즉각적으로 알림을 제공하여 빠른 대응이 가능하도록 함.
