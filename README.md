...
|Anaconda|4.11.x|데이터 과학 및 머신 러닝을 위한 파이썬 배포판|
...
1. 비디오 전처리
    ...
    - 각 프레임을 이미지 파일로 저장
            ...
            [데이터 전처리 시 사용한 영상 데이터]

            C_3_13_1_BU_DYA_08_20_13_41_07_CB_RGB_DF2_F1.mp4

            C_3_13_1_BU_DYA_08_20_13_41_07_CC_RGB_DF2_F1.mp4
...
2. [vision Yolov5-Webcam], https://jackyoon5737.tistory.com/189
3. 파이썬으로 email 보내기, https://hyeshin.oopy.io/ds/python/20200620_py20_python_email
